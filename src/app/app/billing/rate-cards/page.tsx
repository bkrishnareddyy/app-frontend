      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="px-4 py-2 rounded-lg text-xs font-semibold bg-white hover:bg-slate-50 text-ink transition-colors border border-[#E5E5EA] shadow-sm"
          >
            + Create Rate Card
          </Link>
        </div>
                  ...
                  return (
                    <tr key={rc.id} className="hover:bg-[#F9F9FB] transition-colors">
                      <td className="px-5 py-4 font-bold text-ink">
                        {rc.name}
                        {rc.isDefault && (
                          <span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-blue-50 text-brand border border-blue-100">
                            Default
                          </span>
                        )}
                      </td>
                      ...
                      <td className="px-5 py-4 text-right">
                        <Link
                          ...
                          className="text-xs font-semibold text-brand hover:underline transition-all"
                        >
                          Edit & Map →
                        </Link>
                      </td>
